...
% pfname = 'powRT_090924_CAR_intra_hg70110'; %from old scripts
% pfname = 'powRT_031324_CAR_hg70-110'; % main, pre
% pfname = 'powRT_050624_CAR_intra_hg70-110'; %main, intra, diff hg range CAR
...
% gfname = 'graphRT_031025_CAR_PLV_hg70110'; %plv instead of qexp
gfname = 'graphRT_031025_CAR_PLVSS1_hg70110'; %plv instead of qexp
...
% fname8020 = '80-20-dat-pCAR-plvCAR-hg70110-031025'; %pretrial from old scripts - PLV
fname8020 = '80-20-dat-pCAR-plvCARSS1-hg70110-031025'; %plv ss
% fname8020 = '80-20-dat-pCAR-qCAR-hg70110-intra-090924'; %intratrial from old scripts
...
SVMdat = 1; % 0 = 8fs (normal); 1 = 4fsqexp (or 4fsPLV); 2 = 4fspow; 3 = anatomically guided; 4 = anatomical nodes
...
%     thresh_null = thresh;
    ...
    thresh_null = .3; %nullType = 3: .15; nullType = 2: .4; nullType = 0: same as thresh
else
    thresh = 0;
    thresh_null= 0;
end
...
AUCs_pretrial_plvSS1 = AUCas(:,1);
% AUCs_pretrial_PLV_qexpOnly = AUCas(:,1);
% AUCs_pretrial_powOnly = AUCas(:,1);
% AUCs_intratrial_allNodes = AUCas(:,2);
% AUCs_intratrial_nonsigNodes = AUCas(:,3);
% AUCs_pretrial_prevTrial = AUCas(:,4);

save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_pre_plvSS1_031125.mat','AUCs_pretrial_plvSS1')
% save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_pre_PLV_qexpOnly_031125.mat','AUCs_pretrial_PLV_qexpOnly')
% save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_pre_powOnly_092824.mat','AUCs_pretrial_powOnly')
% save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_intra_allNodes_092824.mat','AUCs_intratrial_allNodes')
% save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_intra_nonsigNodes_092824.mat','AUCs_intratrial_nonsigNodes')
% save('/mnt/sdb1/CCDT/CCDTscripts/Figures/NullComparisonAUCs/AUCs_pre_prevTrial_092824.mat','AUCs_pretrial_prevTrial')
